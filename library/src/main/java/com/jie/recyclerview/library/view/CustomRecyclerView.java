...
//                        Log.i("getVisibleHeight", " mRefreshHeader.getState() = " + mRefreshHeader.getState());
        ...
        if (mItemClickListener!=null) {
            viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    mItemClickListener.onItemClick(viewHolder.getAdapterPosition() - mHeaderViews.size());
                }
            });
        }
        ...
        if (mItemLongClickListener!=null){
            viewHolder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    return mItemLongClickListener.onItemClick(viewHolder.getAdapterPosition()-mHeaderViews.size());
                }
            });
        }
    }
    ...
    private class WrapAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            ViewHolder simpleViewHolder = adapter.onCreateViewHolder(parent, viewType);
            setItemClickListener(simpleViewHolder);
